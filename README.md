...
This repository contains a collection of small, practical React applications.
Each project focuses on a single concept — state, props, events, forms, API fetching, routing, UI logic, and reusable components.
...
✔ Practicing small UI/UX components
✔ Preparing for interviews
✔ Creating a strong GitHub portfolio
✔ Understanding real-world React patterns
