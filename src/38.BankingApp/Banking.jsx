    ...
    <>
      <div className="min-h-screen bg-gray-900 flex flex-col items-center p-6 text-white">
        ...
        <div className="bg-gray-800 p-4 rounded-lg text-center mb-6 w-full max-w-md shadow-lg">
          ...
          <h2 className="text-2xl font-bold text-gray-400">${balance}</h2>
        </div>
        {/* Input Section */}
        <div className="flex gap-2 w-full max-w-md mb-6">
          ...
          <button
            onClick={deposit}
            className="px-4 py-2 bg-gray-500 hover:bg-green-600 rounded-lg"
          >
            Deposit
          </button>
          <button
        ...
        <div className="w-full max-w-md bg-gray-800 p-4 rounded-lg shadow-lg">
          ...
          {transactions.length === 0 ? (
            <p className="text-gray-400 text-center">No Transaction Yet</p>
          ) : (
            <ul className="space-y-2">
              {transactions.map((t) => (
                ...
                >
                  ...
                  <span
                    className={`${
                      t.type === "Deposit" ? "text-gray-400" : "text-red-400"
                    }`}
                  >
                    ${t.amount}
                  </span>
